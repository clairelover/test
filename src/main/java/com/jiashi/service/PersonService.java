...
public interface PersonService {
  ...
  //添加人员信息
  public  String addUserInfo(String username,String userid,String enterTime,String userConnect,String emerContPer,String emrContCont, String password) throws Exception;
